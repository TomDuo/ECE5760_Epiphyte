...
ub = [100 500 1000 5000 10000 20000];
  ...
  fprintf('reg  signed [19:0] y;\n');
  fprintf('reg  signed [19:0] x;\n');
for i= 1:length(lb)
  if i ~= length(lb)
    fprintf('reg  signed [19:0] z%i;\n',i );
  end
  fprintf('reg  signed [19:0] a%i;\n',i );
  fprintf('reg  signed [19:0] b%i;\n',i );
  fprintf('wire signed [19:0] mul_a%i_y;\n',i);
  fprintf('wire signed [19:0] mul_b%i_x;\n',i);
