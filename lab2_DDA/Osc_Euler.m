...
d1 = 2e-6 ; % damping coefficient -- need some for stability

k2 = 1; % spring coeff
k23 = 0; %spring 2 cubic term coeff
d2 = 2e-6 ; % damping coefficient -- need some for stability

k_middle = 0 ;  % spring coeff
k_middle_3 = 0;

% need small time step for stability
Fs = 256 ;
dt = 1/Fs ;
tspan = 0:dt:dt*640*16 ; %seconds 
